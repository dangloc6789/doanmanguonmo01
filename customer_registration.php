	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">	
			<div class="navbar-header">
				<a href="index.php" class="navbar-brand">Cannabis Shop</a>
			</div>
		...
		<div class="row">
			...
			<div class="col-md-8">
				<div class="panel panel-primary">
					<div class="panel-heading text-center">Form đăng kí</div>
					...
					<form id="signup_form" onsubmit="return false">
						<div class="row">
							...
							<div class="col-md-6">
								<label for="f_name">Họ và tên đệm</label>
						...
						<div class="row">
							<div class="col-md-12">
								<input style="width:100%;" value="Đăng kí" type="submit" name="signup_button"class="btn btn-success btn-lg">
							</div>
						</div>
